...
const Banner = () => {
    ...
    return (
        ...
        <div className="relative isolate min-h-screen flex flex-col">
            ...
            /> */}
            <img
                src="/images/idf7-small.jpg"
                srcSet="/images/idf7-small.jpg 600w, /images/idf7-large.jpg 1200w"
            ...
            <div className="flex flex-col flex-grow">
                ...
                <div className="flex-grow flex items-center justify-center mt-8">
                    <div className="text-center px-4">
                        <h1
                            className={`${lang === 'en' ? 'text-4xl lg:text-5xl md:text-5xl' : 'text-5xl'
                                } font-semibold text-primary text-banner`}
                        >
                            {t('pereh association')}
                        </h1>
